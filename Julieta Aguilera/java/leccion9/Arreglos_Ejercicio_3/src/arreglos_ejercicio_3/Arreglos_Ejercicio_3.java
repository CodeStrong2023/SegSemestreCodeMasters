/*
Ejercicio 3: Leer 5 numero por el teclado, almacenar en 
un arreglo y a continuacion la media de los numeros positivos,
...
public class Arreglos_Ejercicio_3 {
    public static void main(String[] args) {
        ...
        if(conteo_positivos ==0){
            System.out.println("\nNo puede sacar la media de los numero");
        }
        else{
