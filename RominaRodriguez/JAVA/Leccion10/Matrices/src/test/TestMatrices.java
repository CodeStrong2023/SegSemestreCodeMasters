...
public class TestMatrices {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Recorremos a travś del ciclo for");
        ...
        System.out.println("Recorremos a través del ciclo for");
        //Sintaxixs simplificada
...
//        }
        ...
        personas[1][0] = new Persona("Lautaro");
        personas[1][1] = new Persona("Naira");
