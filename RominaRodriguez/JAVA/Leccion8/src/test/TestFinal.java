...
se combina con el modificador de acceso estático para convertier una variables 
en una constante, es decir que no se puede modificar su valor, el ejemplo de 
esto es la clase Math en la cuál todos sus atributos son de tipo static y final,
...
public class TestFinal {
    public static void main(String[] args) {
        ...
        //persona1 = new Persona();No se puede asignar una nueva referncia 
